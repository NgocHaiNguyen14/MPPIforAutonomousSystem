...
xd= [100;70;100;0;0;0;0;0;0;0;0;0]; % Changed target to match iLQR
...
function J = finalCost(xT, xd)
    % Enhanced final cost with your adjusted weights and altitude constraint
    Qf_pos = 20 * diag([5, 5, 7]);        % Position weights (your adjustment)
    Qf_vel = 20 * diag([5, 5, 5]);         % Velocity weights (your adjustment)
    Qf_ang = 20 * diag([5, 5, 1]);         % Angle weights (your adjustment)
